...
- [DGP1](https://github.com/ygeunkim/paper-bvhar/blob/master/docs/model-bvar.md) BVAR(5)
- DGP2
- [DGP3](https://github.com/ygeunkim/paper-bvhar/blob/master/docs/model-bvhar.md) BVHAR-S
- DGP4
