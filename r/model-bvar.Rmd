...
bvar_small_spec %>% 
  kable_hyperparam(
    caption = "BVAR(5) and BVHAR True Hyperparameters - SMALL", 
    label = "smalltruespec"
  ) %>% 
  writeLines()
```
...
bvar_small_spec %>% 
  kable_hyperparam(
    caption = "BVAR(5) and BVHAR True Hyperparameters - MEDIUM",
    label = "medtruespec"
  ) %>% 
  writeLines()
```
...
bvar_large_spec %>% 
  kable_hyperparam(
    caption = "BVAR(5) and BVHAR True Hyperparameters - LARGE",
    label = "largetruespec"
  ) %>% 
  writeLines()
```
