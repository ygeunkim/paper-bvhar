...
```{r smalldgp2setting, comment=NULL, echo=FALSE}
bvar_small_spec <- dgp$small_spec
```

```{r meddgp2setting, comment=NULL, echo=FALSE}
bvar_medium_spec <- dgp$medium_spec
```

```{r largedgp2setting, comment=NULL, echo=FALSE}
bvar_large_spec <- dgp$large_spec
```

```{r dgp2settingtab, comment=NULL, echo=FALSE}
bvar_spec_list <- list(
...
bvar_spec_list %>% 
  report_true_hyperparam(model_name = "DGP2-BVAR(5)", caption = "Hyperparameters for DGP2-BVAR(5).", label = "dgp2-truehyperparam") %>% 
  writeLines()
```
...
```{r optimhyperparam, comment=NULL, echo=FALSE}
dgp1_spec_list <- list(
  small = list(
    bvar_small_optim$spec,
    bvhar_var_small_optim$spec,
...
```{r dgp2-smallcvonefig, echo=FALSE}
cv_small_1 %>% 
  gg_loss(
    y_small_test, 
    mean_line = TRUE, 
...
```{r dgp2-smallcvfivefig, echo=FALSE}
cv_small_5 %>% 
  gg_loss(
    y_small_test, 
    mean_line = TRUE, 
...
```{r dgp2-smallcvtwentyfig, echo=FALSE}
cv_small_20 %>% 
  gg_loss(
    y_small_test, 
    mean_line = TRUE, 
