...
knitr::opts_chunk$set(
  ...
  collapse = TRUE,
  out.width = "70%",
  fig.path = "../output/figs/DGP-BVAR-WN-",
  fig.align = "center",
  fig.width = 6,
  fig.asp = .618
)
