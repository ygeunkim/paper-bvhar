...
bvhar_small_spec %>% 
  kable_hyperparam(caption = "\\label{tab:smallbvharspec}BVHAR Coefficient Simulation Setting - SMALL") %>% 
  writeLines()
```
...
bvhar_small_spec %>% 
  kable_hyperparam(caption = "\\label{tab:medbvharspec}BVHAR Coefficient Simulation Setting - MEDIUM") %>% 
  writeLines()
```
...
bvhar_large_spec %>% 
  kable_hyperparam(caption = "\\label{tab:largebvharspec}BVHAR Coefficient Simulation Setting - LARGE") %>% 
  writeLines()
```
