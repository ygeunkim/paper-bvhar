---
title: "Simulating VHAR-type Minnesota BVHAR"
...
knitr::opts_chunk$set(
  ...
  collapse = TRUE,
  out.width = "70%",
  fig.path = "../output/figs/DGP-BVHAR-L-",
  fig.align = "center",
  fig.width = 6,
  fig.asp = .618
)
...
# report-------------------
report_hyperparam(spec_optim_list, report_true = FALSE, caption = "Empirical Bayes Results for DGP4.", label = "empdgp4") %>% 
  writeLines()
```
...
get_rmafetex_tr(
  ...
  benchmark_id = 1,
  caption = "Out-of-sample forecasting performance measures for DGP4 with VAR(5) model as benchmark.", 
  label = "dgp4result",
  header_angle = 0
) %>% 
  writeLines()
